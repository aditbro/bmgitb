    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('koreksi', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.Kunjungan')),
            ],
        ),
        migrations.CreateModel(
            name='Obat',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kategori_pasien', models.CharField(max_length=100)),
                ('kode', models.CharField(max_length=100)),
                ('keterangan', models.CharField(max_length=800, null=True)),
                ('max_subsidi_per_kunjungan', models.IntegerField()),
                ('sisa_subsidi_bulan_ini', models.IntegerField()),
                ('sisa_subsidi_tahunan', models.IntegerField()),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alamat', models.CharField(max_length=800, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kode', models.CharField(max_length=100, null=True)),
                ('keterangan', models.CharField(max_length=800)),
                ('max_subsidi_per_kunjungan', models.IntegerField()),
                ('sisa_subsidi_bulan_ini', models.IntegerField()),
                ('sisa_subsidi_tahunan', models.IntegerField()),
