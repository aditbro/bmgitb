...
#     try:
#         required_column = ['no_pasien', 'klinik', 'dokter', 'asal', 'tarif', 'klaim', 'cash']
...
#         data_kunjungan['klinik'] = Klinik.objects.get(kode=data_kunjungan['klinik'])
...
#             data_kunjungan = {'kunjungan':model_to_dict(kunjungan), 'klinik':model_to_dict(klinik), 'dokter':model_to_dict(dokter), 'pasien':model_to_dict(pasien)}
